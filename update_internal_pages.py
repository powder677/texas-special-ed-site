    ...
    for district_folder in os.listdir(DISTRICTS_DIR):
        ...
        for target_page in TARGET_PAGES:
            ...
            if os.path.exists(filepath):
                ...
                if style_tag and new_style_element:
                    style_tag.replace_with(new_style_element)
                elif soup.head and new_style_element:
                    soup.head.append(new_style_element)

                # 2. AGGRESSIVE NAV/HEADER REMOVAL & REPLACEMENT
                # Eradicate any existing <header> OR <nav> so they don't get stuck inside the container
                ...
                # Add the fresh footer to the end of the <body>
