...
# Your exact list of districts with the cities cleaned up for the [[DISTRICT_CITY]] token
TARGET_DISTRICTS = [
...
def generate_short_name(name):
    ...
    # Special overrides for large districts
    special_cases = {
...
def main():
    ...
    # Strip out the instruction comment block so it doesn't get published
    template = re.sub(r'', '', template, flags=re.DOTALL)

    count = 0
    print("🚀 Starting generation of top Texas district pages...\n")
    ...
    for district in TARGET_DISTRICTS:
        ...
        print(f"Generating: {dist_name}...")

        # Replace the 4 exact tokens
    ...
    print(f"\n✅ Success! Successfully generated {count} complete FIE pages.")
