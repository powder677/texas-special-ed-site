...
# ======================================================================
# ARTICLE DATA (Titles, Files, and Tags)
# ======================================================================
EN_ARTICLES = [
...
def generate_cards_html(articles):
    ...
    for art in articles:
        ...
        html += f"""
        <a href="{art['file']}" class="blog-card {urgent_class}">
...
# ======================================================================
# LANGUAGE DICTIONARIES (Maps directly to your placeholders)
# ======================================================================
CONTENT_EN = {
    "PAGE_LANG": "en",
    ...
    # Erase remaining unused tags for clean output
...
# Duplicate EN to ES, then overwrite the specific Spanish translations
...
def build_hubs():
    ...
    # Generate Blog Card HTML strings
    cards_en_html = generate_cards_html(EN_ARTICLES)
    cards_es_html = generate_cards_html(ES_ARTICLES)

    # Inject the grids into the base template so they are ready for both versions
    ...
    # Strip any remaining un-filled tags
    ...
    # Hide the English tab by default on the Spanish page, show Spanish grid
